...
//    postgrasp_joint_ = pregrasp_joint_;
    ...
    pregrasp_cola_joint_.resize(joint_names_.size());
    pregrasp_cola_joint_[0] = 0.0;
    pregrasp_cola_joint_[1] = 2.9;
    pregrasp_cola_joint_[2] = 1.5;
    pregrasp_cola_joint_[3] = -2.07;
    pregrasp_cola_joint_[4] = 1.4;
    pregrasp_cola_joint_[5] = 0.0;
...
bool PickPlace::my_pick()
{
    ...
    ROS_INFO_STREAM("close the gripper partially ...");
    gripper_action(0.5*FINGER_MAX); // partially close
    ///////////////////////////////////////////////////////////
    //// test move_group functionality
    ///////////////////////////////////////////////////////////
    // geometry_msgs::PoseStamped current_pose = group_->getCurrentPose();

    // std::ostringstream oss;
    // oss << "Current x-coordinate is " << current_pose.pose.position.x;
    ...
    //// grasp cola
    ///////////////////////////////////////////////////////////
    ROS_INFO_STREAM("Send robot to pre-grasp cola position ...");
    group_->setJointValueTarget(pregrasp_cola_joint_);
