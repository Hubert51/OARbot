function [outputArg1,outputArg2] = open_microwave2(hObject,inputArg2)
% open microwave, 
% only need to open the first stage
    ...
    fix_pos = robotArm.getPos() + [0; 0.08; 0];
...
%     robotArm.cartesian_pose_client([0; -0.055; 0], rotm2quat(result)', 1);
    ...
    robotArm.cartesian_pose_client([0; -0.3; 0], robotArm.getOri(), 1);
