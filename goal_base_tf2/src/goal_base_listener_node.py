...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        try:
            ...
            T_base2goal2 = tfBuffer.lookup_transform('goal_base_id_{}_frame'.format(base_id), 'goal_base_id_{}_added_frame'.format(goal2_id), rospy.Time())
            ...
            T_goal2tobase = tfBuffer.lookup_transform('goal_base_id_{}_added_frame'.format(goal2_id), 'goal_base_id_{}_frame'.format(base_id), rospy.Time())
