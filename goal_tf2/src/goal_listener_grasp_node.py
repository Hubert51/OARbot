...
if __name__ == '__main__':
    rospy.init_node('tf2_goal_listener_grasp')
    ...
    mode = 0 # 1: Reach to goal, 2: Close Fingers, 3: Move to Goal_after
    ...
    while not rospy.is_shutdown():
        ...
        if (mode == 2):
            ...
            finger_goal.fingers.finger1 = 7000.0
            finger_goal.fingers.finger2 = 7000.0
            finger_goal.fingers.finger3 = 7000.0
