...
## Installation
This is a wrapper on the kinova-api. Make sure to download the proper version of the kinova-api and install for your robot at [kinovarobotics.com](http://www.kinovarobotics.com)
[Jaco2](https://drive.google.com/file/d/1dDk3BoWXXT68u9_syI5O3J5PPg66lF7X/view)
[Mico](https://drive.google.com/file/d/0B790iVm0vRTlUkV2ZnBDdGVuM2M/view)

1. Make the necissary files executable  e.g. `chmod +x installSDK64.sh` & `chmod +x SDK_JACO2_1.4.0_install64`
2. Run setup scripts from terminal as super user e.g. `sudo ./installSDK64.sh`
