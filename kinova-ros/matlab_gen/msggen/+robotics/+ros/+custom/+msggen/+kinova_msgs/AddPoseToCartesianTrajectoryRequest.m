classdef AddPoseToCartesianTrajectoryRequest < robotics.ros.Message
    %AddPoseToCartesianTrajectoryRequest MATLAB implementation of kinova_msgs/AddPoseToCartesianTrajectoryRequest
    ...
    properties (Constant)
        MessageType = 'kinova_msgs/AddPoseToCartesianTrajectoryRequest' % The ROS message type
    end
    ...
    methods
        function obj = AddPoseToCartesianTrajectoryRequest(msg)
            %AddPoseToCartesianTrajectoryRequest Construct the message object AddPoseToCartesianTrajectoryRequest
        ...
        function set.X(obj, x)
            ...
            validateattributes(x, {'numeric'}, {'nonempty', 'scalar'}, 'AddPoseToCartesianTrajectoryRequest', 'X');
        ...
        function set.Y(obj, y)
            ...
            validateattributes(y, {'numeric'}, {'nonempty', 'scalar'}, 'AddPoseToCartesianTrajectoryRequest', 'Y');
        ...
        function set.Z(obj, z)
            ...
            validateattributes(z, {'numeric'}, {'nonempty', 'scalar'}, 'AddPoseToCartesianTrajectoryRequest', 'Z');
        ...
        function set.ThetaX(obj, thetax)
            ...
            validateattributes(thetax, {'numeric'}, {'nonempty', 'scalar'}, 'AddPoseToCartesianTrajectoryRequest', 'ThetaX');
        ...
        function set.ThetaY(obj, thetay)
            ...
            validateattributes(thetay, {'numeric'}, {'nonempty', 'scalar'}, 'AddPoseToCartesianTrajectoryRequest', 'ThetaY');
        ...
        function set.ThetaZ(obj, thetaz)
            ...
            validateattributes(thetaz, {'numeric'}, {'nonempty', 'scalar'}, 'AddPoseToCartesianTrajectoryRequest', 'ThetaZ');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.kinova_msgs.AddPoseToCartesianTrajectoryRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.kinova_msgs.AddPoseToCartesianTrajectoryRequest;
            obj.reload(strObj);
        end
    end
end
