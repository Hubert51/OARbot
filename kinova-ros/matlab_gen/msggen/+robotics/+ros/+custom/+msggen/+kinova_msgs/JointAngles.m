classdef JointAngles < robotics.ros.Message
    %JointAngles MATLAB implementation of kinova_msgs/JointAngles
    ...
    properties (Constant)
        MessageType = 'kinova_msgs/JointAngles' % The ROS message type
    end
    ...
    methods
        function obj = JointAngles(msg)
            %JointAngles Construct the message object JointAngles
        ...
        function set.Joint1(obj, joint1)
            ...
            validateattributes(joint1, {'numeric'}, {'nonempty', 'scalar'}, 'JointAngles', 'Joint1');
        ...
        function set.Joint2(obj, joint2)
            ...
            validateattributes(joint2, {'numeric'}, {'nonempty', 'scalar'}, 'JointAngles', 'Joint2');
        ...
        function set.Joint3(obj, joint3)
            ...
            validateattributes(joint3, {'numeric'}, {'nonempty', 'scalar'}, 'JointAngles', 'Joint3');
        ...
        function set.Joint4(obj, joint4)
            ...
            validateattributes(joint4, {'numeric'}, {'nonempty', 'scalar'}, 'JointAngles', 'Joint4');
        ...
        function set.Joint5(obj, joint5)
            ...
            validateattributes(joint5, {'numeric'}, {'nonempty', 'scalar'}, 'JointAngles', 'Joint5');
        ...
        function set.Joint6(obj, joint6)
            ...
            validateattributes(joint6, {'numeric'}, {'nonempty', 'scalar'}, 'JointAngles', 'Joint6');
        ...
        function set.Joint7(obj, joint7)
            ...
            validateattributes(joint7, {'numeric'}, {'nonempty', 'scalar'}, 'JointAngles', 'Joint7');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.kinova_msgs.JointAngles.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.kinova_msgs.JointAngles;
            obj.reload(strObj);
        end
    end
end
