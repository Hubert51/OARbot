classdef ArmPoseActionGoal < robotics.ros.Message
    ...
    properties (Constant, Access = protected)
        ...
        KinovaMsgsArmPoseGoalClass = robotics.ros.msg.internal.MessageFactory.getClassForType('kinova_msgs/ArmPoseGoal') % Dispatch to MATLAB class for message type kinova_msgs/ArmPoseGoal
    ...
    methods
        function obj = ArmPoseActionGoal(msg)
            %ArmPoseActionGoal Construct the message object ArmPoseActionGoal
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'ArmPoseActionGoal', 'Header');
        ...
        function set.GoalId(obj, goalid)
            ...
            validateattributes(goalid, {obj.ActionlibMsgsGoalIDClass}, {'nonempty', 'scalar'}, 'ArmPoseActionGoal', 'GoalId');
        ...
        function goal = get.Goal(obj)
            ...
            if isempty(obj.Cache.Goal)
                obj.Cache.Goal = feval(obj.KinovaMsgsArmPoseGoalClass, obj.JavaMessage.getGoal);
            end
            goal = obj.Cache.Goal;
        end
        ...
        function set.Goal(obj, goal)
            ...
            validateattributes(goal, {obj.KinovaMsgsArmPoseGoalClass}, {'nonempty', 'scalar'}, 'ArmPoseActionGoal', 'Goal');
    ...
    methods (Access = protected)
        ...
        function reload(obj, strObj)
            ...
            obj.Goal = feval([obj.KinovaMsgsArmPoseGoalClass '.loadobj'], strObj.Goal);
        end
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.kinova_msgs.ArmPoseActionGoal.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.kinova_msgs.ArmPoseActionGoal;
            obj.reload(strObj);
        end
    end
end
