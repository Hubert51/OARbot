classdef JointVelocity < robotics.ros.Message
    %JointVelocity MATLAB implementation of kinova_msgs/JointVelocity
    ...
    properties (Constant)
        MessageType = 'kinova_msgs/JointVelocity' % The ROS message type
    end
    ...
    methods
        function obj = JointVelocity(msg)
            %JointVelocity Construct the message object JointVelocity
        ...
        function set.Joint1(obj, joint1)
            ...
            validateattributes(joint1, {'numeric'}, {'nonempty', 'scalar'}, 'JointVelocity', 'Joint1');
        ...
        function set.Joint2(obj, joint2)
            ...
            validateattributes(joint2, {'numeric'}, {'nonempty', 'scalar'}, 'JointVelocity', 'Joint2');
        ...
        function set.Joint3(obj, joint3)
            ...
            validateattributes(joint3, {'numeric'}, {'nonempty', 'scalar'}, 'JointVelocity', 'Joint3');
        ...
        function set.Joint4(obj, joint4)
            ...
            validateattributes(joint4, {'numeric'}, {'nonempty', 'scalar'}, 'JointVelocity', 'Joint4');
        ...
        function set.Joint5(obj, joint5)
            ...
            validateattributes(joint5, {'numeric'}, {'nonempty', 'scalar'}, 'JointVelocity', 'Joint5');
        ...
        function set.Joint6(obj, joint6)
            ...
            validateattributes(joint6, {'numeric'}, {'nonempty', 'scalar'}, 'JointVelocity', 'Joint6');
        ...
        function set.Joint7(obj, joint7)
            ...
            validateattributes(joint7, {'numeric'}, {'nonempty', 'scalar'}, 'JointVelocity', 'Joint7');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.kinova_msgs.JointVelocity.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.kinova_msgs.JointVelocity;
            obj.reload(strObj);
        end
    end
end
