classdef ArmPoseResult < robotics.ros.Message
    %ArmPoseResult MATLAB implementation of kinova_msgs/ArmPoseResult
    ...
    properties (Constant)
        MessageType = 'kinova_msgs/ArmPoseResult' % The ROS message type
    end
    ...
    methods
        function obj = ArmPoseResult(msg)
            %ArmPoseResult Construct the message object ArmPoseResult
        ...
        function set.Pose(obj, pose)
            ...
            validateattributes(pose, {obj.GeometryMsgsPoseStampedClass}, {'nonempty', 'scalar'}, 'ArmPoseResult', 'Pose');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.kinova_msgs.ArmPoseResult.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.kinova_msgs.ArmPoseResult;
            obj.reload(strObj);
        end
    end
end
