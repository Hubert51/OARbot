classdef ArmPoseFeedback < robotics.ros.Message
    %ArmPoseFeedback MATLAB implementation of kinova_msgs/ArmPoseFeedback
    ...
    properties (Constant)
        MessageType = 'kinova_msgs/ArmPoseFeedback' % The ROS message type
    end
    ...
    methods
        function obj = ArmPoseFeedback(msg)
            %ArmPoseFeedback Construct the message object ArmPoseFeedback
        ...
        function set.Pose(obj, pose)
            ...
            validateattributes(pose, {obj.GeometryMsgsPoseStampedClass}, {'nonempty', 'scalar'}, 'ArmPoseFeedback', 'Pose');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.kinova_msgs.ArmPoseFeedback.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.kinova_msgs.ArmPoseFeedback;
            obj.reload(strObj);
        end
    end
end
