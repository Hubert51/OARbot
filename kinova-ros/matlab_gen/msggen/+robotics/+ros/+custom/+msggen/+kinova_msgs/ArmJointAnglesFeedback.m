classdef ArmJointAnglesFeedback < robotics.ros.Message
    %ArmJointAnglesFeedback MATLAB implementation of kinova_msgs/ArmJointAnglesFeedback
    ...
    properties (Constant)
        MessageType = 'kinova_msgs/ArmJointAnglesFeedback' % The ROS message type
    end
    ...
    methods
        function obj = ArmJointAnglesFeedback(msg)
            %ArmJointAnglesFeedback Construct the message object ArmJointAnglesFeedback
        ...
        function set.Angles(obj, angles)
            ...
            validateattributes(angles, {obj.KinovaMsgsJointAnglesClass}, {'nonempty', 'scalar'}, 'ArmJointAnglesFeedback', 'Angles');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.kinova_msgs.ArmJointAnglesFeedback.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.kinova_msgs.ArmJointAnglesFeedback;
            obj.reload(strObj);
        end
    end
end
